...
export interface ProfilesService<P extends Requester | GarageOwner | ServiceProvider, DTO extends RequesterProfileDto|GarageOwnerDto|ProviderDto> extends BaseDbService<P, DTO> {
